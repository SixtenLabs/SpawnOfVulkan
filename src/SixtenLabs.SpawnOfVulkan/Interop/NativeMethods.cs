...
namespace SixtenLabs.SpawnOfVulkan
{
    internal static class NativeMethods
    {
        ...
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern IntPtr GetDeviceProcAddr(Device @device, string* @pName);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern IntPtr GetInstanceProcAddr(Instance @instance, string* @pName);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        ...
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern Result EnumerateInstanceExtensionProperties(string* @pLayerName, uint* @pPropertyCount, ExtensionProperties* @pProperties);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        ...
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern Result EnumerateDeviceExtensionProperties(PhysicalDevice @physicalDevice, string* @pLayerName, uint* @pPropertyCount, ExtensionProperties* @pProperties);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        ...
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern Result MapMemory(Device @device, DeviceMemory @memory, ulong @offset, ulong @size, MemoryMapFlags @flags, IntPtr* @ppData);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        ...
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern Result ResetDescriptorPool(Device @device, DescriptorPool @descriptorPool, DescriptorPoolResetFlags @flags);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        ...
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern IntPtr DebugReportMessageExt(Instance @instance, DebugReportFlagsExt @flags, DebugReportObjectTypeExt @objectType, ulong @object, UIntPtr @location, int @messageCode, string* @pLayerPrefix, string* @pMessage);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern Result DebugMarkerSetObjectNameExt(Device @device, DebugMarkerObjectNameInfoExt* @pNameInfo);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern Result DebugMarkerSetObjectTagExt(Device @device, DebugMarkerObjectTagInfoExt* @pTagInfo);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern IntPtr CmdDebugMarkerBeginExt(CommandBuffer @commandBuffer, DebugMarkerMarkerInfoExt* @pMarkerInfo);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern IntPtr CmdDebugMarkerEndExt(CommandBuffer @commandBuffer);
        //[DllImport(VulkanLibrary, CallingConvention = CallingConvention.StdCall)]
        //internal static unsafe extern IntPtr CmdDebugMarkerInsertExt(CommandBuffer @commandBuffer, DebugMarkerMarkerInfoExt* @pMarkerInfo);
    }
}