...
namespace SixtenLabs.SpawnOfVulkan
{
    public static partial class Vk
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Winapi)]
        public delegate Result MapMemoryDelegate(Device @device, DeviceMemory @memory, ulong @offset, ulong @size, uint @flags, IntPtr @ppData);
        [UnmanagedFunctionPointer(CallingConvention.Winapi)]
        ...
        [UnmanagedFunctionPointer(CallingConvention.Winapi)]
        public delegate Result ResetDescriptorPoolDelegate(Device @device, DescriptorPool @descriptorPool, uint @flags);
        [UnmanagedFunctionPointer(CallingConvention.Winapi)]
